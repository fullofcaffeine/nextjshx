...
EXPECTED_GENES_TOOLING_VERSION = "0.2.0"
EXPECTED_GENES_TOOLING_URL = (
    "https://github.com/fullofcaffeine/genes-ts/releases/download/"
    "tooling-v0.2.0/genes-ts-tooling-0.2.0.tgz"
)
EXPECTED_GENES_TOOLING_INTEGRITY = (
    "sha512-A5fg4R6xoU/G8Z44vVO6yLzAXPYwKz+GjVnTpRCLQHqbkPuh5A+N0OSuK+iNm0o3"
    "dPBfxyMbntgh+ku4KOWQOQ=="
)
...
EXPECTED_NANOID_VERSION = "3.3.18"
...
EXPECTED_GENES_VERSION = "1.50.0"
EXPECTED_GENES_COMMIT = "603ed8349775f86438a8b5be99cafa1a36544644"
