...
/**
 * Fixed-schema file repository with an ignored runtime state and tracked seed.
 *
 ...
 */
class TodoStore {
	static inline final DEFAULT_CONTROL_PATH = ".nextjshx";
	static inline final RUNS_PATH = ".nextjshx/runs";
	static inline final SEED_PATH = "data/seed.tsv";
	static inline final HEADER = "id\tcompleted\tpriority\ttitle\tnote";
	static inline final RECEIPT_HEADER = "operation\tmutation_id";
	static var writeSequence = 0;

	public static function list():Array<Todo> {
	...
	public static function cacheScope():String {
	...
	public static function find(id:TodoId):Null<Todo> {
		for (todo in list()) {
			if (todo.id == id) {
				return todo;
			}
	...
	public static function create(title:String, note:String, priority:TodoPriority):Todo {
	...
	public static function toggle(id:TodoId):Bool {
		final todos = list();
	...
	public static function remove(id:TodoId):Bool {
		final todos = list();
	...
	public static function reorder(ids:Array<TodoId>):Bool {
		final current = list();
	...
	public static function wasApplied(operation:TodoMutationOperation, mutationId:TodoMutationId):Bool {
	 ...
	 */
	public static function rememberApplied(operation:TodoMutationOperation, mutationId:TodoMutationId):Void {
		final receipt = receiptPath();
	...
	static function decode(raw:String):Array<Todo> {
	...
	static function validateText(value:String, maximum:Int, label:String, lineNumber:Int):Void {
	...
	static function nextId(title:String, todos:Array<Todo>):TodoId {
	 ...
	 */
	static function persist(todos:Array<Todo>):Void {
	...
	static function decodeReceipts(raw:String):Array<String> {
		final normalized = raw.replace("\r\n", "\n");
		if (normalized.indexOf("\r") != -1) {
	...
	static function persistReceipts(receipts:Array<String>):Void {
		final control = controlPath();
		final receipt = receiptPath();
		NodeFiles.mkdirSync(control, {recursive: true, mode: 0x1C0});
		writeSequence++;
