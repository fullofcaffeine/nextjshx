...
/** Deterministic typed catalogue shared by listing, detail, and metadata. */
class ProductCatalog {
	public static function all():Array<Product> {
		return [
			{
	...
	public static function find(slug:ProductSlug):Null<Product> {
		for (product in all()) {
