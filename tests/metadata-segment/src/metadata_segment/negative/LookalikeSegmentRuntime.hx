...
@:next.page("negative/lookalike-runtime")
class LookalikeSegmentRuntime {
	public static final segment = SegmentConfig.create({runtime: foreign.api.SegmentRuntime.NodeJs});
